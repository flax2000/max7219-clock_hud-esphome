...
//modefied by swedude to have same width on the numbers and move the numbers to give room for a : in the middle
...
void MAX7219Component::send_char(uint8_t chip, uint8_t data) {
	if(chip==0)
{
this->max_displaybuffer_[0][chip * 8 + 0] = 0;
this->max_displaybuffer_[0][chip * 8 + 1] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][5])<<1;
this->max_displaybuffer_[0][chip * 8 + 2] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][4])<<1;
this->max_displaybuffer_[0][chip * 8 + 3] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][3])<<1;
this->max_displaybuffer_[0][chip * 8 + 4] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][2])<<1;
this->max_displaybuffer_[0][chip * 8 + 5] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][1])<<1;
this->max_displaybuffer_[0][chip * 8 + 6] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][0])<<1;
this->max_displaybuffer_[0][chip * 8 + 7] = 0;			
}
if(chip==1)
{
this->max_displaybuffer_[0][chip * 8 + 0] = 0;
this->max_displaybuffer_[0][chip * 8 + 1] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][6])<<1;
this->max_displaybuffer_[0][chip * 8 + 2] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][5])<<1;
this->max_displaybuffer_[0][chip * 8 + 3] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][4])<<1;
this->max_displaybuffer_[0][chip * 8 + 4] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][3])<<1;
this->max_displaybuffer_[0][chip * 8 + 5] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][2])<<1;
this->max_displaybuffer_[0][chip * 8 + 6] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][1])<<1;
this->max_displaybuffer_[0][chip * 8 + 7] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][0])<<1;

}
if(chip==2)
{
this->max_displaybuffer_[0][chip * 8 + 0] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][5])<<1;
this->max_displaybuffer_[0][chip * 8 + 1] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][4])<<1;
this->max_displaybuffer_[0][chip * 8 + 2] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][3])<<1;
this->max_displaybuffer_[0][chip * 8 + 3] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][2])<<1;
this->max_displaybuffer_[0][chip * 8 + 4] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][1])<<1;
this->max_displaybuffer_[0][chip * 8 + 5] = progmem_read_byte(&MAX7219_DOT_MATRIX_FONT[data][0])<<1;
this->max_displaybuffer_[0][chip * 8 + 6] = 0;
this->max_displaybuffer_[0][chip * 8 + 7] = 0;		
}
if(chip==3)
{
